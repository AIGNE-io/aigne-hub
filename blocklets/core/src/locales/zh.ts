...
export default flatten({
  ...
  providerIdentifierHint: '仅支持小写字母、数字和连字符',
  displayName: '显示名称',
  ...
  deleteProvider: '删除',
  deleteProviderConfirm: '确定要删除供应商"{{name}}"吗？这将同时删除其所有凭证和模型费率。',
  ...
  'gateway.description': '通过 Cloudflare AI Gateway 路由 AI 请求，获得缓存、分析和可靠性能力',
  'gateway.active': '已启用',
  'gateway.inactive': '未启用',
  'gateway.enable': '启用 Gateway',
  'gateway.enableDesc': '启用后，支持的模型将优先通过 Gateway 路由，失败时自动降级到直连',
  'gateway.connection': '连接配置',
  'gateway.accountId': '账户 ID',
  'gateway.gatewayId': 'Gateway ID',
  'gateway.authToken': '认证令牌',
  'gateway.authTokenHelp': '如果 Gateway 启用了认证，则需要填写此项',
  'gateway.gatewayUrl': 'Gateway 地址',
  'gateway.providerRouting': '提供商路由',
  'gateway.enableHint': '启用 Gateway 后，支持的提供商将通过 Cloudflare AI Gateway 路由',
  'gateway.countGateway': '{count} 个走 Gateway',
  'gateway.countDirect': '{count} 个走直连',
  'gateway.supported': 'Gateway ({slug})',
  'gateway.optedOut': '已排除（使用自有凭证）',
  'gateway.notSupported': '直连',
  'gateway.saved': 'Gateway 配置已保存',
  'gateway.enabled': 'Gateway 已启用',
  'gateway.disabled': 'Gateway 已禁用',
  'gateway.envSource': '使用环境变量中的值',
  'gateway.edit': '编辑',
  'gateway.cancel': '取消',
  'gateway.save': '保存',
  'gateway.show': '显示',
