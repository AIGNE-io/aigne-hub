...
export default flatten({
  ...
  providerIdentifierHint: 'Only lowercase letters, numbers, and hyphens',
  ...
  deleteProviderConfirm: 'Are you sure you want to delete provider "{{name}}"? This will also remove all its credentials and model rates.',
  ...
  'gateway.description': 'Route AI requests through Cloudflare AI Gateway for caching, analytics, and reliability',
  'gateway.active': 'Active',
  'gateway.inactive': 'Inactive',
  'gateway.enable': 'Enable Gateway',
  'gateway.enableDesc': 'When enabled, supported models route through Gateway first with automatic fallback',
  'gateway.connection': 'Connection',
  'gateway.accountId': 'Account ID',
  'gateway.gatewayId': 'Gateway ID',
  'gateway.authToken': 'Auth Token',
  'gateway.authTokenHelp': 'Required if your Gateway has authentication enabled',
  'gateway.gatewayUrl': 'Gateway URL',
  'gateway.providerRouting': 'Provider Routing',
  'gateway.enableHint': 'Enable Gateway to route supported providers through Cloudflare AI Gateway',
  'gateway.countGateway': '{count} Gateway',
  'gateway.countDirect': '{count} Direct',
  'gateway.supported': 'Gateway ({slug})',
  'gateway.optedOut': 'Opted out (uses own credentials)',
  'gateway.notSupported': 'Direct',
  'gateway.saved': 'Gateway settings saved',
  'gateway.enabled': 'Gateway enabled',
  'gateway.disabled': 'Gateway disabled',
  'gateway.envSource': 'Using value from environment variable',
  'gateway.edit': 'Edit',
