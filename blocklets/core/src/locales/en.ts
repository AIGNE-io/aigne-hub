...
export default flatten({
  ...
  analytics: {
    ...
    includesGrantCredits: 'Grant used {used} / Total grant {total}',
    grantUsedLabel: 'Grant used',
    grantTotalLabel: 'Total grant',
    grantCreditsUsed: 'Grant Credits: {amount}',
    paidCreditsUsed: 'Paid Credits: {amount}',
