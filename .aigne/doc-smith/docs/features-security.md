...
User -> AIGNE-Hub.Authentication.DID-Connect: "1. Login"
AIGNE-Hub.Authentication.DID-Connect -> AIGNE-Hub.Authentication.Blocklet-Server-Auth: "2. Authenticate"
AIGNE-Hub.Authentication.Blocklet-Server-Auth -> AIGNE-Hub.Authentication.auth-db: "3. Manage Session"

User -> AIGNE-Hub.Admin-Panel.RBAC-Middleware: "4. Access Admin Panel"
AIGNE-Hub.Admin-Panel.RBAC-Middleware -> AIGNE-Hub.Admin-Panel.Admin-APIs: "5. Grant/Deny Access"

AIGNE-Hub.Admin-Panel.Admin-APIs -> AIGNE-Hub.Credential-Management.Encryption-Module: "6. Add/Update Provider Keys"
AIGNE-Hub.Credential-Management.Encryption-Module -> AIGNE-Hub.Credential-Management.Encrypted-DB: "7. Store Encrypted Keys"

AIGNE-Hub.Admin-Panel.Admin-APIs -> AIGNE-Hub.Audit-Logging: "Log Admin Action"
AIGNE-Hub.Credential-Management.Encryption-Module -> AIGNE-Hub.Audit-Logging: "Log Credential Event"

AIGNE-Hub.Credential-Management.Encrypted-DB <-> Upstream-AI-Providers: "Securely Stores API Keys for"
```
