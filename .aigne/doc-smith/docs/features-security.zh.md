...
User -> AIGNE-Hub.Authentication.DID-Connect: "1. 登录"
AIGNE-Hub.Authentication.DID-Connect -> AIGNE-Hub.Authentication.Blocklet-Server-Auth: "2. 身份验证"
AIGNE-Hub.Authentication.Blocklet-Server-Auth -> AIGNE-Hub.Authentication.auth-db: "3. 管理会话"

User -> AIGNE-Hub.Admin-Panel.RBAC-Middleware: "4. 访问管理面板"
AIGNE-Hub.Admin-Panel.RBAC-Middleware -> AIGNE-Hub.Admin-Panel.Admin-APIs: "5. 授予/拒绝访问"

AIGNE-Hub.Admin-Panel.Admin-APIs -> AIGNE-Hub.Credential-Management.Encryption-Module: "6. 添加/更新提供商密钥"
AIGNE-Hub.Credential-Management.Encryption-Module -> AIGNE-Hub.Credential-Management.Encrypted-DB: "7. 存储加密密钥"

AIGNE-Hub.Admin-Panel.Admin-APIs -> AIGNE-Hub.Audit-Logging: "记录管理操作"
AIGNE-Hub.Credential-Management.Encryption-Module -> AIGNE-Hub.Audit-Logging: "记录凭证事件"

AIGNE-Hub.Credential-Management.Encrypted-DB <-> Upstream-AI-Providers: "为其安全存储 API 密钥"
```
